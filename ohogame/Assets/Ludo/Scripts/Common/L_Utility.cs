...
public class L_Utility : MonoBehaviour
{
    ...
    public static L_PlayerGameDetails ParseUserDetails(JsonData jsonObject)
    {
    ...
    public static L_PlayerGameDetails ParsePlayerGameData(JsonData jsonObject)
    {
        L_PlayerGameDetails playerData = L_PlayerManager.instance.GetPlayerGameData();
        if (null == playerData)
        {
            playerData = new L_PlayerGameDetails();
        }
