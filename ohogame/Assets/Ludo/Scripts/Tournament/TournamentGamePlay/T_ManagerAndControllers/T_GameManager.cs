...
public class T_GameManager : MonoBehaviour
{
    ...
    public T_Players[] redPlayers, yellowPlayers, greenPlayers, bluePlayers;
    public T_Players[] allPlayers;

    public T_DiceManager rollingDice;
    public T_DiceManager[] manageRollingDice;
